========================================================================
    ActiveX 컨트롤 DLL : AWStitch 프로젝트 개요
========================================================================

컨트롤 마법사에서 컨트롤 한 개가 들어 있는 AWStitch
...
이 파일에는 AWStitch ActiveX 컨트롤 DLL을 구성하는 각각의 파일에
...
AWStitch.ico
    ...
    해당 아이콘은 기본 리소스 파일인 AWStitch.rc에 의해 포함됩니다.

/////////////////////////////////////////////////////////////////////////////
CAWStitchCtrl 컨트롤입니다.

AWStitchCtrl.h
    이 파일에는 CAWStitchCtrl C++ 클래스가 선언되어 있습니다.

AWStitchCtrl.cpp
    이 파일에는  CAWStitchCtrl C++ 클래스가 구현되어 있습니다.

AWStitchPropPage.h
    이 파일에는 CAWStitchPropPage C++ 클래스가 선언되어 있습니다.

AWStitchPropPage.cpp
    이 파일에는 CAWStitchPropPage C++ 클래스가 구현되어 있습니다.

CAWStitchCtrl.bmp
    이 파일에는 CAWStitchCtrl 컨트롤이 도구 팔레트에 표시될 때
    해당 컨트롤을 나타내기 위해 컨테이너에서 사용하는 비트맵이 들어 있습니다.
    해당 비트맵은 기본 리소스 파일인 AWStitch.rc에 의해 포함됩니다.

/////////////////////////////////////////////////////////////////////////////
기타 표준 파일:

Stdafx.h 및 Stdafx.cpp는
    AWStitch.pch라는 이름의 PCH(미리 컴파일된 헤더) 파일과
